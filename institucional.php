                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12 text-center">
                                <h2 class="highlight">Institucional</h2>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-7 col-md-6 col-sm-offset-5 col-md-offset-6 to_animate" data-animation="fadeInRight">
                                <?php echo $function->text('Institucional'); ?>
                                <div class="inline-teasers-wrap">
                                    <a href="https://api.whatsapp.com/send?phone=55<?php echo preg_replace("/[^0-9]/", "", $institucional->whatsApp_institucional); ?>&text=Ola!%20Acabo%20de%20acessar%20o%20site%20da%20<?php echo $institucional->nome_institucional ?>,%20gostaria%20de%20saber%20mais%20sobre%20" class="theme_button color1 margin_0" style="background-color: limegreen; border-color: lime;" onmouseover="this.style.background='green';" onmouseout="this.style.background='limegreen';" >WhatsApp Direct</a>
                                ...
                                <form class="contact-form row columns_margin_bottom_20" method="post" action="">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" aria-required="true" size="30" value="" name="pickup-name" id="pickup-name" class="form-control" placeholder="Nome completo">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" aria-required="true" size="30" value="" name="pickup-phone" id="pickup-phone" class="form-control" placeholder="Telefone">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea aria-required="true" rows="3" cols="45" name="pickup-message" id="pickup-message" class="form-control" placeholder="Mensagem"></textarea>
                                        </div>
                                    </div>
