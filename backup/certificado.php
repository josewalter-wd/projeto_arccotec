                                ...
                                <div class="ds with_background transp_black_bg with_padding">
                                    <form class="contact-form row" method="get" action="#">
                                        <?php if(!$_GET['cod']){ ?>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" aria-required="true" size="30" value="" name="cod" id="name" class="form-control" placeholder="CÓDIGO DO CERTIFICADO" style="width: 680px;">
                                                </div>
                                            </div>
                                        ...
                                        <?php }else{ ?>
                                            ...
                                            <?php //var_dump($val) ?>
                                            <?php if(!$certificado){ echo "<script>alert('Certificado não cadastrado, tente novamente.');history.go(-1)</script>"; exit;} ?>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <i class="fa fa-certificate highlight" aria-hidden="true"></i>
                                                    <input type="text" disabled="disabled" aria-required="true" size="30" value="<?php echo strtoupper($_GET['cod']) ?>" name="cod" id="name" class="form-control" placeholder="CÓDIGO DO CERTIFICADO" style="width: 680px;">
                                                </div>
                                            </div>
                                            <br/><br/><br/>
                                            <div class="col-sm-6">
