...
//--> processamento de dados antes do CRUD
//$_POST['valorPlano1_bairro'] = str_replace(",",".",$_POST['valorPlano1_bairro']);

$_POST['tecnico_certificado'] = strip_tags($_POST['tecnico_certificado']);
$_POST['produtosUtilizados_certificado'] = strip_tags($_POST['produtosUtilizados_certificado']);
$_POST['equipamentosCliente_certificado'] = strip_tags($_POST['equipamentosCliente_certificado']);
...
if ($_GET['c'] == 'cadastrar') {
    ...
    if ($insert->simpleInsert('tb_' . $_GET['m'], $_POST)) {
        ...
        echo "<script>location.href='../../../MODULE.php?c=true&m=" . $_GET['m'] . "'</script>";
        exit;
    } else {
...
//alterar
    ...
    if ($update->simpleUpdate('tb_' . $_GET['m'], $_POST, $_GET['id'], $_GET['a'])) {
        ...
        echo "<script>location.href='../../../MODULE.php?a=true&p=LIST&m=" . $_GET['m'] . "'</script>";
        exit;
    } else {
...
if ($_GET['delete']) {
    ...
    if ($delete->totalDelete('tb_' . $_GET['m'], $_GET['id'], $_GET['delete'])) {
        ...
        echo "<script>location.href='../../../MODULE.php?d=true&p=LIST&m=" . $_GET['m'] . "'</script>";
        exit;
    } else {
