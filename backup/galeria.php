                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12 text-center">
                                <h2 class="highlight">Galeria de Imagens</h2>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="filters isotope_filters darklinks">
                                    <a href="#" class="selected" data-filter="*">Todas as imagens</a>
                                    <?php $tipoGalerias = $query->totalQuery('tb_tipoGaleria', 'nome_tipoGaleria', 'DESC'); ?>
                                    <?php while ($tipoGaleria= mysqli_fetch_object($tipoGalerias)) { ?>
                                        <a href="#" data-filter=".<?php echo $function->normalizaURL($tipoGaleria->nome_tipoGaleria); ?>"><?php echo $tipoGaleria->nome_tipoGaleria ?></a>
                                    <?php } ?>
                                </div>

                                <div class="isotope_container isotope row masonry-layout columns_margin_bottom_20" data-filters=".isotope_filters">
                                    <?php $galerias = $query->totalQuery('tb_galeria', 'rand()', 'DESC'); ?>
                                    <?php while ($galeria= mysqli_fetch_object($galerias)) { ?>
                                        <?php $tipoGaleria = $query->simpleQuery('tb_tipoGaleria', 'id_tipoGaleria', $galeria->id_tipoGaleria) ?>
                                        <div class="isotope-item col-lg-4 col-md-6 col-sm-12 <?php echo $function->normalizaURL($tipoGaleria->nome_tipoGaleria); ?>">
                                            <div class="vertical-item gallery-item content-absolute text-center ds">
                                                <div class="item-media">
                                                    <img src="images/galeria/<?php echo $galeria->imagem_galeria ?>" alt="">
                                                    <div class="media-links">
                                                        <div class="links-wrap">
                                                            <a class="p-view prettyPhoto " title="" data-gal="prettyPhoto[gal]" href="images/galeria/<?php echo $galeria->imagem_galeria ?>"></a>
                                                ...
                                                <div class="item-content darken_gradient">
                                                    <h4 class="poppins">
                                                        <a href="#"><?php echo $galeria->titulo_galeria ?></a>
                                                    </h4>
                                                </div>
                                            </div>
                                        </div>
