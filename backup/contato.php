                        ...
                        <div class="row">
                            <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 text-center">
                                <div class="ds with_background transp_black_bg with_padding">
                                    <form class="contact-form row" method="post" action="processos/contact_me.php?form=contato">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" aria-required="true" size="30" value="" name="nome" id="name" class="form-control" placeholder="Seu nome">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" aria-required="true" size="30" value="" name="telefone" id="phone" class="form-control" placeholder="Telefone">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" aria-required="true" size="30" value="" name="assunto" id="subject" class="form-control" placeholder="Assunto">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea aria-required="true" rows="3" cols="45" name="mensagem" id="message" class="form-control" placeholder="Mensagem"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 bottommargin_0">
                                            <div class="contact-form-submit topmargin_10">
                                                <input type="submit" class="theme_button color2 wide_button margin_0" value="enviar mensagem">
                                                <!--  --
