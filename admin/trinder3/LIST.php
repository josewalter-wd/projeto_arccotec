    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <i class="fa fa-edit"></i> <a href="CRUD.php?m=<?php echo $_GET['m'] ?>"> Cadastrar <?php echo str_replace('_', ' ', $_GET['m']);  ?> </a>
                                </li>
                                <li class="active">
                                            ...
                                            <tbody>
                                                <?php while ($cadastro = mysqli_fetch_array($cadastros)) { ?>
                                                    <tr class="<?php echo $i % 2 == 0 ? 'actions' : 'warning' ?> ">
                                                        ...
                                                        <td style="width: 30%;">
                                                            <a href="CRUD.php?a=<?php echo $cadastro[$campos[0]] ?>&m=<?php echo $_GET['m'] ?>">
        ...
        function confirmDel(id){
            if (confirm("Deseja realmente excluir esse cadastro?")) {
                location.href='CONTROLLER.php?m=<?php echo $_GET['m'] ?>&id=<?php echo $id->id_table ?>&delete='+id;
            }
        }
        </script>
