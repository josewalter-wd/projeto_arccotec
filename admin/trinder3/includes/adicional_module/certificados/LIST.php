                                    ...
                                    <div class="bootstrap-admin-panel-content">
                                        <table class="table bootstrap-admin-table-with-actions">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th style="width: 70%"><?php echo ucfirst(str_replace('_', ' (', $campos[1])) ?>)</th>
                                                    <th>&nbsp;</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php while ($cadastro = mysqli_fetch_array($cadastros)) { ?>
                                                    <tr class="<?php echo $i % 2 == 0 ? 'actions' : 'warning' ?> ">
                                                            <?php $i++; ?>
                                                        <td><?php echo $i ?></td>
                                                        <td><?php echo $cadastro[$campos[1]] ?> - <?php echo $cadastro[$campos[2]] ?></td>
                                                        <td style="width: 40%;">
                                                            <a href="http://arccotec.com.br/certificado.php?cod=<?php echo $cadastro[$campos[1]] ?>&certificate=true">
                                                                <button class="btn btn-sm btn-default">
                                                                    <i class="glyphicon glyphicon-print"></i> Emitir
                                                                </button>
                                                            </a>
